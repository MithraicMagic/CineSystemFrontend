...
const screeningInfo = { "success": true, "message": { "screening": { "id": 15, "language": "English", "movieType": "2D", "date": "2020-06-19T18:30:00", "movie": { "id": 4, "title": "Call Me By Your Name", "imdbID": "tt5726616" }, "theater": { "id": 2, "number": 2, "cinema": { "id": 1, "name": "CineStars Roosendaal", "address": "Wilstraat 34" } } }, "chairs": [{ "id": 36, "type": "Standard" }, { "id": 37, "type": "Standard" }, { "id": 38, "type": "Standard" }, { "id": 39, "type": "Standard" }, { "id": 40, "type": "Standard" }, { "id": 41, "type": "Standard" }, { "id": 42, "type": "Standard" }, { "id": 43, "type": "Standard" }, { "id": 44, "type": "Standard" }, { "id": 45, "type": "Standard" }, { "id": 46, "type": "Standard" }, { "id": 47, "type": "Standard" }, { "id": 48, "type": "Standard" }, { "id": 49, "type": "Standard" }, { "id": 50, "type": "Standard" }, { "id": 51, "type": "Standard" }, { "id": 52, "type": "Standard" }, { "id": 53, "type": "Standard" }, { "id": 54, "type": "Standard" }, { "id": 55, "type": "Standard" }, { "id": 56, "type": "Standard" }, { "id": 57, "type": "Standard" }, { "id": 58, "type": "Standard" }, { "id": 59, "type": "Standard" }, { "id": 60, "type": "Standard" }, { "id": 61, "type": "Standard" }, { "id": 62, "type": "Standard" }, { "id": 63, "type": "Standard" }, { "id": 64, "type": "Standard" }, { "id": 65, "type": "Standard" }, { "id": 66, "type": "Standard" }, { "id": 67, "type": "Standard" }, { "id": 68, "type": "Standard" }, { "id": 69, "type": "Standard" }, { "id": 70, "type": "Standard" }] } };
...
it('Login screen visible for guest', async () => {
    ...
    expect(container.textContent).toBe('Go BackCall Me By Your Name18:30 - CineStars Roosendaal - Theater 21234567891011121314151617181920212223242526272829303132333435You have selected 0 chairsConfirm ReservationLoginSign UpLoading...Okay!Okay!');
